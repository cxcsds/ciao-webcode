...
<!-- $Id: helper.xsl,v 1.69 2004/09/13 20:55:40 dburke Exp $ -->
...
<xsl:stylesheet version="1.0"
  ...
  <xsl:variable name="allowed-sites" select="' ciao sherpa chart caldb pog icxc '"/>
  <xsl:variable name="allowed-download-types" select="' solaris linux6 linux8 osx caldb atomdb '"/>
